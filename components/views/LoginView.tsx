            ...
            <div className="w-full max-w-md p-8 relative z-10">
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full flex justify-center items-center gap-3 py-3 px-4 bg-white hover:bg-slate-50 text-slate-700 rounded-xl font-bold transition-all shadow-lg active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
                    >
