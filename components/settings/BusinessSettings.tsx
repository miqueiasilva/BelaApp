...
const BusinessSettings = ({ onBack }: { onBack: () => void }) => {
    ...
    const handleSave = async () => {
        ...
        setIsSaving(true);
        try {
            // ✅ Utilizando o novo RPC unificado save_business_profile conforme solicitado
            ...
            setToast({ message: "Perfil completo sincronizado com sucesso! ✅", type: 'success' });
